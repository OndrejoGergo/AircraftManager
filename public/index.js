                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <div class="card shadow-sm h-100">
                            ...
                            <div class="card-body">
                                ...
                                <input 
                                    id="imageUrl-${aircraft.id}"
                                    class="form-control mb-2"
                                    value="${aircraft.imageUrl}"
                                    disabled
                                >
                                ...
                                <input 
                                    id="factory-${aircraft.id}"
                                    class="form-control mb-2"
                                    value="${aircraft.factory}"
                                    disabled
                                >
                                ...
                                <input 
                                    type="number"
                                    id="maxSpeed-${aircraft.id}" 
                                    class="form-control mb-2"
                                    value="${aircraft.maxSpeed}"
                                    disabled
                                >
...
async function toggleEdit(id) {
  ...
  if (isNaN(capacity) || isNaN(maxSpeed) || isNaN(range)) {
    alert("Capacity, Max Speed and Range must be numbers!");
    return;
  }
